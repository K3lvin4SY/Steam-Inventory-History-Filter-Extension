...
! function(t, e) {
  ...
  function ce(t, e) {
    ...
    if (!i) return;
    const n = i.listeners,
      o = n.indexOf(e); - 1 !== o && n.splice(o, 1), n.length > 0 || (re.forEach((e => {
      delete t[e]
    })), delete t._chartjs)
  }
  ...
  var Ge = {
    ...
    update(t, e, i, n) {
      ...
      const o = ze(t.options.layout.padding),
        ...
        r = function(t) {
          const e = function(t) {
            ...
            i = je(e.filter((t => t.box.fullSize)), !0),
            n = je(He(e, "left"), !0),
            o = je(He(e, "right")),
            s = je(He(e, "top"), !0),
            a = je(He(e, "bottom")),
      ...
      }(l.concat(c), d), qe(r.fullSize, f, d), qe(l, f, d), qe(c, f, d) && qe(l, f, d),
        function(t) {
  ...
  const fi = t => 0 === t || 1 === t,
    gi = (t, e, i) => -Math.pow(2, 10 * (t -= 1)) * Math.sin((t - e) * _t / i),
    ...
    mi = {
      ...
      easeInOutExpo: t => fi(t) ? t : t < .5 ? .5 * Math.pow(2, 10 * (2 * t - 1)) : .5 * (2 - Math.pow(2, -10 * (2 * t - 1))),
      easeInCirc: t => t >= 1 ? t : -(Math.sqrt(1 - t * t) - 1),
      easeOutCirc: t => Math.sqrt(1 - (t -= 1) * t),
      easeInOutCirc: t => (t /= .5) < 1 ? -.5 * (Math.sqrt(1 - t * t) - 1) : .5 * (Math.sqrt(1 - (t -= 2) * t) + 1),
      easeInElastic: t => fi(t) ? t : gi(t, .075, .3),
      easeOutElastic: t => fi(t) ? t : pi(t, .075, .3),
      easeInOutElastic(t) {
        const e = .1125;
  ...
  function Ci(t, e) {
    ...
    for (let t = 0; t < d; ++t) {
      ...
      u = (i._stacks || (i._stacks = {}))[c] = Pi(o, h, n), u[r] = s, u._top = Di(u, a, !0), u._bottom = Di(u, a, !1)
    }
  }
  ...
  class Ri {
    ...
    buildOrUpdateElements(t) {
      ...
      e._dataCheck();
      const s = i._stacked;
      i._stacked = Si(i.vScale, i), i.stack !== n.stack && (o = !0, Ai(i), i.stack = n.stack), e._resyncElements(t), (o || s !== i._stacked) && Ci(e, i._parsed)
    }
    configure() {
      const t = this,
        e = t.chart.config,
    ...
    _resyncElements(t) {
      ...
      const o = n.length,
        s = i.length,
        a = Math.min(s, o);
      s > o ? e._insertElements(o, s - o, t) : s < o && e._removeElements(s, o - s), a && e.parse(0, a)
    }
  ...
  function Bi(t, e) {
    ...
    if (s > 0) {
      ...
      for (Wi(e, l, c, $(n) ? 0 : a - n, a), t = 0, i = s - 1; t < i; t++) Wi(e, l, c, o[t], o[t + 1]);
  ...
  function qi(t, e = [""], i = t, n, o = (() => t[0])) {
    ...
    return new Proxy(s, {
      ...
      get: (i, n) => Ji(i, n, (() => function(t, e, i, n) {
        let o;
        for (const s of e)
          if (o = an(Zi(s, t), i), ht(o)) return Qi(t, o) ? on(i, n, t, o) : o
      }(n, e, t, i))),
  ...
  function Ki(t, e, i, n) {
    ...
    return new Proxy(o, {
      ...
      get: (t, e, i) => Ji(t, e, (() => function(t, e, i) {
        const {
          _proxy: n,
          _context: o,
          _subProxy: s,
  ...
  function on(t, e, i, n) {
    ...
    r.add(n);
    let l = sn(r, a, i, s || i);
    return null !== l && ((!ht(s) || s === i || (l = sn(r, a, s, l), null !== l)) && qi([...r], [""], o, s, (() => function(t, e, i) {
  ...
  function un(t, e = "x") {
    ...
    function(t, e, i) {
      ...
      for (let h = 0; h < n - 1; ++h) l = c, c = cn(t, h + 1), l && c && (Tt(e[h], 0, ln) ? i[h] = i[h + 1] = 0 : (o = i[h] / e[h], s = i[h + 1] / e[h], r = Math.pow(o, 2) + Math.pow(s, 2), r <= 9 || (a = 3 / Math.sqrt(r), i[h] = o * a * e[h], i[h + 1] = s * a * e[h])))
    }(t, o, s),
    function(t, e, i = "x") {
      const n = hn(i),
        o = t.length;
  ...
  function gn(t, e, i, n, o) {
    let s, a, r, l;
    if (e.spanGaps && (t = t.filter((t => !t.skip))), "monotone" === e.cubicInterpolationMode) un(t, o);
    else {
      let i = n ? t[t.length - 1] : t[0];
      for (s = 0, a = t.length; s < a; ++s) r = t[s], l = dn(i, r, t[Math.min(s + 1, a - (n ? 0 : 1)) % a], e.tension), r.cp1x = l.previous.x, r.cp1y = l.previous.y, r.cp2x = l.next.x, r.cp2y = l.next.y, i = r
    }
    e.capBezierPoints && function(t, e) {
      let i, n, o, s, a, r = Gt(t[0], e);
      for (i = 0, n = t.length; i < n; ++i) a = s, s = r, r = i < n - 1 && Gt(t[i + 1], e), s && (o = t[i], a && (o.cp1x = fn(o.cp1x, e.left, e.right), o.cp1y = fn(o.cp1y, e.top, e.bottom)), r && (o.cp2x = fn(o.cp2x, e.left, e.right), o.cp2y = fn(o.cp2y, e.top, e.bottom)))
    }(t, i)
  }
  ...
  function Mn(t, e, i) {
    ...
    const y = () => b || l(o, x, p) && 0 !== r(o, x),
      v = () => !b || 0 === r(s, p) || l(s, x, p);
    for (let t = h, i = h; t <= d; ++t) m = e[t % a], m.skip || (p = c(m[n]), p !== x && (b = l(p, o, s), null === _ && y() && (_ = 0 === r(p, o) ? t : i), null !== _ && v() && (g.push(wn({
      start: _,
      end: t,
      loop: u,
      count: a,
  ...
  var Tn = new class {
    constructor() {
      this.controllers = new An(Ri, "datasets", !0), this.elements = new An(Ei, "elements"), this.plugins = new An(Object, "plugins"), this.scales = new An(Xi, "scales"), this._typedRegistries = [this.controllers, this.scales, this.elements]
    }
    add(...t) {
  ...
  class jn {
    ...
    getOptionScopes(t, e, i) {
      ...
      const r = new Set;
      e.forEach((e => {
        t && (r.add(t), e.forEach((e => Nn(r, t, e)))), e.forEach((t => Nn(r, n, t))), e.forEach((t => Nn(r, ft[o] || {}, t))), e.forEach((t => Nn(r, xt, t))), e.forEach((t => Nn(r, gt, t)))
      }));
      const l = [...r];
  ...
  class to {
    ...
    buildOrUpdateControllers() {
      ...
      for (t._removeUnreferencedMetasets(), n = 0, o = i.length; n < o; n++) {
        ...
        if (s.type && s.type !== a && (t._destroyDatasetMeta(n), s = t.getDatasetMeta(n)), s.type = a, s.indexAxis = o.indexAxis || In(a, t.options), s.order = o.order || 0, t._updateMetasetIndex(s, n), s.label = "" + o.label, s.visible = t.isDatasetVisible(n), s.controller) s.controller.updateIndex(n), s.controller.linkScales();
        else {
  ...
  function lo(t, e, i, n) {
    const o = t.iScale,
      ...
      l = [];
    let c, h, d, u;
    for (c = i, h = i + n; c < h; ++c) u = e[c], d = {}, d[o.axis] = r || o.parse(a[c], c), l.push(ro(u, d, s, c));
    return l
  }
  ...
  class ho extends Ri {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let d, u, f, g;
      for (d = i, u = i + n; d < u; ++d) g = e[d], f = {}, f[o.axis] = o.parse(lt(g, l), d), h.push(ro(lt(g, c), f, s, d));
      return h
    }
    updateRangeFromParsed(t, e, i, n) {
      ...
      for (let h = e; h < e + i; h++) {
        const e = o.getParsed(h),
          ...
          p = {
            horizontal: l,
            base: i.base,
            enableBorderRadius: !g || co(e._custom) || o.index === g._top || o.index === g._bottom,
            x: l ? i.head : f.center,
            y: l ? f.center : i.head,
    ...
    draw() {
      const t = this,
        ...
        s = o.length;
      let a = 0;
      for (Zt(e.ctx, e.chartArea); a < s; ++a) null !== t.getParsed(a)[n.axis] && o[a].draw(t._ctx);
      Qt(e.ctx)
    }
  }
  ...
  class uo extends Ri {
    ...
    updateElements(t, e, i, n) {
      ...
      for (let l = e; l < e + i; l++) {
        ...
        c.skip = isNaN(f) || isNaN(g), h && (c.options = o.resolveDataElementOptions(l, n), s && (c.options.radius = 0)), o.updateElement(e, l, c, n)
      }
        ...
        } = e._getRotationExtents(),
        {
          ...
          if (e < _t) {
            const r = t,
              ...
              d = Math.cos(l),
              u = Math.sin(l),
              f = (t, e, n) => Ht(t, r, l, !0) ? 1 : Math.max(e, e * i, n, n * i),
              g = (t, e, n) => Ht(t, r, l, !0) ? -1 : Math.min(e, e * i, n, n * i),
              p = f(0, c, d),
              m = f(Mt, h, u),
              x = g(bt, c, d),
              b = g(bt + Mt, h, u);
  ...
  class go extends Ri {
    ...
    updateElements(t, e, i, n) {
      ...
      for (let c = e; c < e + i; ++c) {
        ...
        g.skip = isNaN(_) || isNaN(y) || b, g.stop = c > 0 && i[u] - x[u] > p, g.parsed = i, d && (g.options = h || o.resolveDataElementOptions(c, n)), m || o.updateElement(e, c, g, n), x = i
      }
  ...
  function Mo(t, e, i) {
    const {
      ...
      pixelMargin: r,
      innerRadius: l
    } = e, c = Math.max(e.outerRadius + i - r, 0), h = l > 0 ? l + i + r : 0, d = a - s, u = (d - Math.max(.001, d * c - i / bt) / c) / 2, f = s + u, g = a - u, {
      outerStart: p,
      outerEnd: m,
      innerStart: x,
      innerEnd: b
    } = vo(e, h, c, g - f), _ = c - p, y = c - m, v = f + p / _, w = g - m / y, M = h + x, k = h + b, S = f + x / M, P = g - b / k;
  ...
  function ko(t, e, i) {
    const {
      options: n
    } = e, o = "inner" === n.borderAlign;
    n.borderWidth && (o ? (t.lineWidth = 2 * n.borderWidth, t.lineJoin = "round") : (t.lineWidth = n.borderWidth, t.lineJoin = "bevel"), e.fullCircles && function(t, e, i) {
      const {
        x: n,
        y: o,
        startAngle: s,
      ...
      let h;
      for (i && (e.endAngle = e.startAngle + _t, yo(t, e), e.endAngle = a, e.endAngle === e.startAngle && (e.endAngle += _t, e.fullCircles--)), t.beginPath(), t.arc(n, o, c, s + _t, s, !0), h = 0; h < e.fullCircles; ++h) t.stroke();
      for (t.beginPath(), t.arc(n, o, l, s, s + _t), h = 0; h < e.fullCircles; ++h) t.stroke()
    }(t, e, o), o && yo(t, e), Mo(t, e, i), t.stroke())
  }
  class So extends Ei {
    constructor(t) {
    ...
    draw(t) {
      const e = this,
        i = e.options,
        n = (i.offset || 0) / 2;
      if (e.pixelMargin = "inner" === i.borderAlign ? .33 : 0, e.fullCircles = Math.floor(e.circumference / _t), 0 === e.circumference || e.innerRadius < 0 || e.outerRadius < 0) return;
      t.save();
      let o = 0;
      if (n) {
        o = n / 2;
        const i = (e.startAngle + e.endAngle) / 2;
        t.translate(Math.cos(i) * o, Math.sin(i) * o), e.circumference >= bt && (o = n)
      }
      t.fillStyle = i.backgroundColor, t.strokeStyle = i.borderColor,
        function(t, e, i) {
          ...
          isNaN(e.circumference) || (e.endAngle = e.startAngle + e.circumference % _t), Mo(t, e, i), t.fill()
        }(t, e, o), ko(t, e, o), t.restore()
    }
  }
  ...
  function To(t) {
    ...
    return !(t._decimated || t._loop || e.tension || "monotone" === e.cubicInterpolationMode || e.stepped || i) ? Ao : Oo
  }
  ...
  function Ro(t, e, i, n) {
    Lo && 1 === e.segments.length ? function(t, e, i, n) {
      ...
      for (const r of o) Po(t, s, r.style), t.beginPath(), a(t, e, r, {
        start: i,
        end: i + n - 1
  ...
  function No(t) {
    const e = Fo(t),
      ...
      s = function(t, e, i) {
        ...
        } = t.getProps(["enableBorderRadius"]), o = t.options.borderRadius, s = Ie(o), a = Math.min(e, i), r = Vo(t), l = n || U(o);
        return {
  ...
  function hs(t, e) {
      ...
      for (const t of n) {
        ...
        for (const e of r) {
          ...
          for (const t of l) a.push({
            ...
            target: e,
            start: {
              [i]: rs(n, r, "start", Math.max)
            },
            end: {
              [i]: rs(n, r, "end", Math.min)
            }
          })
        }
      }
    ...
    for (const {
      ...
      const u = !!n.pathSegment(t, l, {
        ...
        f = d && u;
      f || cs(t, n, c, o), t.closePath(), t.fill(f ? "evenodd" : "nonzero"), t.restore()
    }
  }
  ...
  var us = {
    ...
    afterDatasetsUpdate(t, e, i) {
      const n = (t.data.datasets || []).length,
        o = [];
      let s, a, r, l;
      for (a = 0; a < n; ++a) s = t.getDatasetMeta(a), r = s.dataset, l = null, r && r.options && r instanceof Eo && (l = {
      ...
      for (a = 0; a < n; ++a) l = o[a], l && !1 !== l.fill && (l.fill = os(o, a, i.propagate))
    },
    beforeDraw(t, e, i) {
  ...
  class gs extends Ei {
    ...
    _draw() {
      ...
      const {
        ...
        boxHeight: b,
        itemHeight: _
      } = fs(l, g), y = t.isHorizontal(), v = this._computeTitleHeight();
      m = y ? {
  ...
  class Os extends Ei {
    ...
    drawTitle(t, e, i) {
      ...
      if (s) {
        ...
        for (t.x = Ps(n, i.titleAlign, i), e.textAlign = c.textAlign(i.titleAlign), e.textBaseline = "middle", a = Fe(i.titleFont), r = i.titleSpacing, e.fillStyle = i.titleColor, e.font = a.string, l = 0; l < s; ++l) e.fillText(o[l], c.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + r, l + 1 === s && (t.y += i.titleMarginBottom - r)
      }
    }
    ...
    drawFooter(t, e, i) {
      ...
      if (s) {
        ...
        for (t.x = Ps(n, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = l.textAlign(i.footerAlign), e.textBaseline = "middle", a = Fe(i.footerFont), e.fillStyle = i.footerColor, e.font = a.string, r = 0; r < s; ++r) e.fillText(o[r], l.x(t.x), t.y + a.lineHeight / 2), t.y += a.lineHeight + i.footerSpacing
      }
    }
    ...
    _positionChanged(t, e) {
      const {
        ...
        caretY: n,
        options: o
      } = this, s = bs[o.position].call(this, t, e);
  ...
  class Rs extends Xi {
    ...
    parse(t, e) {
      ...
      return ((t, e) => null === t ? null : Nt(Math.round(t), 0, e))(e = isFinite(e) && i[e] === t ? e : Ls(i, t, K(e, t)), i.length - 1)
    }
    determineDataLimits() {
      const t = this,
        {
  ...
  class Is extends Xi {
    ...
    buildTicks() {
      ...
      const o = function(t, e) {
        ...
        w = Math.ceil(g / M) - Math.floor(f / M), w > u && (M = Ct(w * M / u / d) * d), $(a) || (_ = Math.pow(10, a), M = Math.ceil(M * _) / _), y = Math.floor(f / M) * M, v = Math.ceil(g / M) * M, p && m && n && Lt((s - o) / n, M / 1e3) ? (w = Math.min((s - o) / M, l), M = (s - o) / w, y = o, v = s) : x ? (y = p ? o : y, v = m ? s : v, w = r - 1, M = (v - y) / w) : (w = (v - y) / M, w = Tt(w, Math.round(w), M / 1e3) ? Math.round(w) : Math.ceil(w));
        const k = Math.max(zt(M), zt(y));
        _ = Math.pow(10, $(a) ? k : a), y = Math.round(y * _) / _, v = Math.round(v * _) / _;
        let S = 0;
        for (p && (h && y !== o ? (i.push({
            value: o
          }), y < o && S++, Tt(Math.round((y + S * M) * _) / _, o, Es(o, b, t)) && S++) : y < o && S++); S < w; ++S) i.push({
          value: Math.round((y + S * M) * _) / _
        });
        return m && h && v !== s ? Tt(i[i.length - 1].value, s, Es(s, b, t)) ? i[i.length - 1].value = s : i.push({
          value: s
        }) : m && v !== s || i.push({
          value: v
        }), i
  ...
  class Ys extends Is {
    ...
    generateTickLabels(t) {
      const e = this;
      Is.prototype.generateTickLabels.call(e, t), e._pointLabels = e.getLabels().map(((t, i) => {
  ...
  class Js extends Xi {
    ...
    buildTicks() {
      ...
      return t._unit = i.unit || (n.autoSkip ? Gs(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function(t, e, i, n, o) {
        for (let s = Xs.length - 1; s >= Xs.indexOf(i); s--) {
          const i = Xs[s];
          if (Us[i].common && t._adapter.diff(o, n, i) >= e - 1) return i
        }
    ...
    _generate() {
      ...
      return d !== n && "ticks" !== o.bounds && 1 !== u || Zs(h, d, g), Object.keys(h).sort(((t, e) => t - e)).map((t => +t))
    }
    getLabelForValue(t) {
  ...
  return to.register(_o, ia, Uo, Ts), to.helpers = {
    ...On
  }, to._adapters = so, to.Animation = _i, to.Animations = vi, to.animator = a, to.controllers = Tn.controllers.items, to.DatasetController = Ri, to.Element = Ei, to.elements = Uo, to.Interaction = Oe, to.layouts = Ge, to.platforms = ui, to.Scale = Xi, to.Ticks = Vi, Object.assign(to, _o, ia, Uo, Ts, ui), to.Chart = to, "undefined" != typeof window && (window.Chart = to), to
}));